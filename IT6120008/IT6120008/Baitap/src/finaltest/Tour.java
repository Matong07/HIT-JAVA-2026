...
public class Tour extends Product implements Comparable<Tour> {
	...
	// objects
	private String tour_number_dates;// số ngày đi tuor
	private String tour_transport;// Phương tiện di chuyển
	...
	public double getTotalPrice() {
		...
		return this.getProduct_total() * this.getProduct_price() + this.getProduct_price() * 10 / 100;
	}

...
public class Creamic_Tile extends Product1 {

	// Danh mục sản phẩm
		public static Category[] generateCategory(int n) {
			// Khai báo danh sách trung gian
			Category[] listCategory = new Category[n];

			// Khai báo danh mục đồ nội thất gỗ và gạch ốp lát
			String[] category_name = { "Furniture", "Ceramic tiles" };
			...
			for (int i = 0; i < listCategory.length; i++) {
				...
				if (listCategory[i].getCategory_name() == "Funiture") {
					...
					listCategory[i].setPro_producer(pro_producer1[index]);
				}
			}
			return listCategory;
		}

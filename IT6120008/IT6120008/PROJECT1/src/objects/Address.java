...
public class Address {
	...
	public static void main(String[] args) {
		...
		Address d2 = new Address("Tuyên Quang");
		Address d3 = new Address("Tuyên Quang", "Chiêm Hóa");
		Address d4 = new Address("Tuyên Quang", "Chiêm Hóa", "Tri Phú");
...
//		System.out.println(d3);
		...
		// Thay đổi thông tin cho d4
		d4.setCityName("Hà Nội ").setDistrictName("Bắc Từ Liêm ");
		System.out.println(d4);
